						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="text" 
									   ...
									   autofocus>
								<div class="error_events_name text-danger text-sm text-bold pt-1"></div>
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group">
								...
								<div class="error_events_organizer_id text-danger text-sm text-bold pt-1"></div>
							</div>
						</div>
					</div>
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								...
								<div class="error_events_circuit_id text-danger text-sm text-bold pt-1"></div>
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group">
								...
								<div class="error_events_type_id text-danger text-sm text-bold pt-1"></div>
							</div>
						</div>
					</div>
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								<label for="events_quantity"><?= lang('backend/events.form.quantityField'); ?></label>
								<input type="text" 
									   class="form-control" 
									   id="events_quantity" 
									   name="events_quantity" 
									   placeholder="<?= lang('backend/events.form.quantityPlaceholder'); ?>">
								<div class="error_events_quantity text-danger text-sm text-bold pt-1"></div>
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group">
								<label for="events_price"><?= lang('backend/events.form.priceField'); ?></label>
								<input type="text" 
									   class="form-control" 
									   id="events_price" 
									   name="events_price" 
									   placeholder="<?= lang('backend/events.form.pricePlaceholder'); ?>">
								<div class="error_events_price text-danger text-sm text-bold pt-1"></div>
							</div>
						</div>
					</div>
					<div class="row">
						<div class="col-md-12">
							<div class="form-group">
								...
								<div class="error_events_short_description text-danger text-sm text-bold pt-1"></div>
							</div>
						</div>
					</div>
					<div class="row">
						<div class="col-md-12">
							<div class="form-group">
								...
								<div class="error_events_long_description text-danger text-sm text-bold pt-1"></div>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="card-body">
				    <div class="row">
			    	    <div class="col-md-12 text-center">
			    			<button type="button" class="btn btn-link getCircuitsTypes"><i class="fas fa-plus-circle"></i> <?= lang('backend/events.buttons.addDatesSlots'); ?></button>
			    	     </div>
			    	     <div class="col-md-12">
			    	     	<hr>
			    	     </div>
		    		    ...
		    		    <div class="col-md-12">
		    		    	...
		    		    	<div class="error_circuits_types text-danger text-sm text-bold text-center pt-1"></div>
		    		    </div>
				    </div>
				</div>
				<div class="card-header">
				...
				<div class="card-body">
				    <div class="col-md-12">
				        <div class="form-group">
				            ...
				            <div class="error_files text-danger text-sm text-bold pt-1"></div>
				        </div>
				    </div>
			    </div>
				<div class="card-header">
					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								...
								<div class="error_slug text-danger text-sm text-bold pt-1"></div>
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group">
								...
								<div class="error_title text-danger text-sm text-bold pt-1"></div>
							</div>
						</div>
						<div class="col-md-12">
							<div class="form-group">
								...
								<div class="error_description text-danger text-sm text-bold pt-1"></div>
							</div>
						</div>
					</div>
				</div>
