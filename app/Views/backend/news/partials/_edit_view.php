						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<select name="news_organizer_id" id="news_organizer_id" class="form-control">
									<option value=""><?= lang('backend/news.form.organizersSelect'); ?></option>
									<?php foreach($organizersDropdown as $organizer): ?>
										<option value="<?= esc($organizer->organizers_id); ?>"<?= ($news->news_organizer_id == $organizer->organizers_id) ? ' selected' : null; ?>>
					...
					<div class="row">
						<div class="col-md-12">
							<div class="form-group">
								...
								<textarea class="form-control" id="news_short_description" name="news_short_description" placeholder="<?= lang('backend/news.form.shortContentFieldPlaceholder'); ?>" rows="7"><?= esc($news->news_short_description); ?></textarea>
					...
					<div class="row">
						<div class="col-md-12">
							<div class="form-group">
								...
								<textarea class="form-control" id="news_long_description" name="news_long_description" placeholder="<?= lang('backend/news.form.longContentFieldPlaceholder'); ?>" rows="7"><?= esc($news->news_long_description); ?></textarea>
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="text" 
									   ...
									   id="title" 
									   name="title" 
									   value="<?= esc($news->meta_tags_title); ?>" 
						...
						<div class="col-md-12">
							<div class="form-group">
								...
								<input type="text" 
									   ...
									   id="description" 
									   name="description" 
									   value="<?= esc($news->meta_tags_description); ?>" 
