					...
					<div class="col-md-12">
						<div class="card bar">
							<div class="row">
								<div class="col-md-3">
									<div class="bar_item_first">
										<a href="<?= base_url('admin/organizers'); ?>">
											<i class="fas fa-flag-checkered"></i> <?= lang('backend/organizers.title.main') ?>
										</a>
									</div>
								</div>
								<div class="col-md-3">
								...
								<div class="col-md-3">
									<div class="bar_item">
										<a href="<?= base_url('admin/organizers/edit/' . $organizer->organizers_id); ?>">
				...
				<div class="row">
					<div class="col-md-12">
						<div class="content" id="showData">
							<?= $this->include('backend/organizers/partials/_show_view'); ?>
						</div>
					</div>
				</div>
			</div>
