						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="text" 
									   ...
									   id="circuits_name" 
									   name="circuits_name" 
									   value="<?= esc($circuit->circuits_name); ?>" 
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="text" 
									   ...
									   value="<?= esc($circuit->circuits_address); ?>" 
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="text" 
									   ...
									   id="circuits_email" 
									   name="circuits_email" 
									   value="<?= esc($circuit->circuits_email); ?>" 
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="text" 
									   ...
									   id="circuits_phone" 
									   name="circuits_phone" 
									   value="<?= esc($circuit->circuits_phone); ?>" 
					...
					<div class="row">
						<div class="col-md-12">
							<div class="form-group">
								...
								<textarea class="form-control" id="circuits_opening_time" name="circuits_opening_time" placeholder="<?= lang('backend/circuits.form.openingTimeFieldPlaceholder'); ?>" rows="7"><?= esc($circuit->circuits_opening_time); ?></textarea>
					...
					<div class="row">
						<div class="col-md-12">
							<div class="form-group">
								...
								<textarea class="form-control" id="circuits_short_description" name="circuits_short_description" placeholder="<?= lang('backend/circuits.form.shortDescriptionFieldPlaceholder'); ?>" rows="7"><?= esc($circuit->circuits_short_description); ?></textarea>
					...
					<div class="row">
						<div class="col-md-12">
							<div class="form-group">
								...
								<textarea class="form-control" id="circuits_long_description" name="circuits_long_description" placeholder="<?= lang('backend/circuits.form.longDescriptionFieldPlaceholder'); ?>" rows="7"><?= esc($circuit->circuits_long_description); ?></textarea>
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="text" 
									   ...
									   id="slug" 
									   name="slug" 
									   value="<?= esc($circuit->meta_tags_slug); ?>" 
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="text" 
									   ...
									   id="title" 
									   name="title" 
									   value="<?= esc($circuit->meta_tags_title); ?>" 
						...
						<div class="col-md-12">
							<div class="form-group">
								...
								<input type="text" 
									   ...
									   id="description" 
									   name="description" 
									   value="<?= esc($circuit->meta_tags_description); ?>" 
