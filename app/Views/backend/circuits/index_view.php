...
<?= $this->section('content') ?>
			...
			<div class="container mt-3">
				<div class="row">
					<div class="col-md-12">
						<div class="accordion" id="accordionCircuits">
							<div class="card">
							    ...
							    <div id="collapseHeader" class="collapse" aria-labelledby="headingHeader" data-parent="#accordionCircuits">
							        <div class="card-body">
							            <div id="Header">
							...
							<div class="card">
							    ...
							    <div id="collapseImage" class="collapse" aria-labelledby="headingImage" data-parent="#accordionCircuits">
							        <div class="card-body">
							            <div id="Image">
						    ...
						    <div class="card">
						        ...
						        <div id="collapseMetaTags" class="collapse" aria-labelledby="headingMetaTags" data-parent="#accordionCircuits">
						            <div class="card-body">
						                <div id="MetaTags">
