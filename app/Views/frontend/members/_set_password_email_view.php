                        ...
                        <tr>
                            <td style="padding:40px 30px 30px 30px; text-align:center; font-size:24px; font-weight:bold;">
                                <a href="<?= base_url(); ?>" style="text-decoration:none;">
                                  <img src="<?= base_url('assets/images/backend/logo-xl.png'); ?>" width="300" alt="Logo" style="width:300px; max-width:100%; height:auto; border:none; text-decoration:none; color:#ffffff;">
                                </a>
                            </td>
                        </tr>
...
<?php case 'registration': ?>
						...
						<tr>
						    <td style="padding: 30px 30px 0 30px; background-color:#ffffff;">
						        ...
						        <p style="margin:0;">
						            <p>Ciao <?= esc($firstname) . ' ' . esc($lastname); ?>, sei stato registrato con successo a <b>Book4Track</b>!</p>
                        ...
                        <tr>
                            <td style="padding:30px; text-align:center; font-size:12px; background-color:#404040; color:#cccccc;">
                                <p style="margin:0 0 8px 0;">
                                    <a href="https://www.facebook.com/book4track/" style="text-decoration:none;">
                                        <img src="<?= base_url('assets/images/backend/facebook.png'); ?>" width="40" height="40" alt="f" style="display:inline-block; color:#cccccc;">
                                    </a> 
                                    <a href="https://twitter.com/Book4Track/" style="text-decoration:none;">
                                        <img src="<?= base_url('assets/images/backend/twitter.png'); ?>" width="40" height="40" alt="t" style="display:inline-block; color:#cccccc;">
                                    </a> 
                                    <a href="https://www.instagram.com/book4track/" style="text-decoration:none;">
                                        <img src="<?= base_url('assets/images/backend/instagram.png'); ?>" width="40" height="40" alt="i" style="display:inline-block; color:#cccccc;">
                                    </a>
                                </p>
                                <p style="margin:0;font-size:14px;line-height:20px;">&reg; <b>Book4Track 2021</b></p>
                            </td>
                        </tr>
                    </table>
                    <!--[if mso]>
