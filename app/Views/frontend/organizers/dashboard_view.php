			...
			<div class="container-fluid">
				<div class="row">
					...
					<div class="col-md-10 mt-3">
						<div class="row">
							<div class="col-md-6">
								<h3><?= lang('frontend/organizers.title.dashboard'); ?></h3>
							</div>
						...
						<div class="row">
							<div class="col-md-12">
								...
								<p class="font-weight-bold">Un box le tue vendite, mettendo la vista degli eventi venduti</p>
								<p class="font-weight-bold">Un box I tuoi ordini, mettendo la vista degli ordini ricevuti</p>
								<p class="font-weight-bold">Un box I tuoi eventi, mettendo la vista degli eventi correnti</p>
							</div>
						</div>
					</div>
				</div>
