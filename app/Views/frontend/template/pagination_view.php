<?php $mainClasses = (isset($subSection) && ! empty($subSection)) ? $subSection . ' pagination ' : 'pagination '; ?>

<?php $numofpages = ceil($data['pagination']['totalRows'] / $data['pagination']['limit']); ?>

<div class="row mb-2">
    <div class="col-md-4">
        <?php $left = ($data['pagination']['totalRows'] == 0) ? '' : lang('frontend/global.pagination.infoLeft', [$data['pagination']['page'], $numofpages]); ?>
        <div class="pagination_left"><?= $left ?></div>
    </div>
    <div class="col-md-4">
        <ul class="<?= $mainClasses; ?>pagination-sm justify-content-center">
        ...
        <?php if ($data['pagination']['totalRows'] > $data['pagination']['limit']): ?>
            ...
            <?php else: ?>
                ...
                <li class="page-item"><a class="page-link" href="#" data-page="1"><?= lang('frontend/global.pagination.linkFirst') ?></a></li>
                <li class="page-item"><a class="page-link" href="#" data-page="<?= $pageprev ?>"><?= lang('frontend/global.pagination.linkPrevious') ?></a></li>
            ...
            <?php if(($data['pagination']['totalRows'] - ($data['pagination']['limit'] * $data['pagination']['page'])) > 0): ?>
                ...
                <li class="page-item"><a class="page-link" href="#" data-page="<?= $pagenext ?>"><?= lang('frontend/global.pagination.linkNext') ?></a></li>
                <li class="page-item"><a class="page-link" href="#" data-page="<?= $numofpages ?>"><?= lang('frontend/global.pagination.linkLast') ?></a></li>
    ...
    <div class="col-md-4">
        ...
        $right = ($data['pagination']['totalRows'] == 0) ? '' : lang('frontend/global.pagination.infoRight', [$result_start, $result_end, $data['pagination']['totalRows']]); ?>
